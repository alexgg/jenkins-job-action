...
use_post_request = os.environ["INPUT_JENKINS_USE_POST_REQUEST"]


def main():
    crumb = get_crumb(jenkins_url, jenkins_user, jenkins_token)
    queue_item_location = queue_job(crumb, jenkins_url, job_name, jenkins_params, jenkins_user, jenkins_token, use_post_request)
